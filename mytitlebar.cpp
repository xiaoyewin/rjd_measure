...
short g_titlebar_height=30;
short g_toolbar_height=100;

#define BUTTON_HEIGHT g_titlebar_height   // 按钮高度;
#define BUTTON_WIDTH g_titlebar_height    // 按钮宽度;
#define TITLE_HEIGHT g_titlebar_height	// 标题栏高度;
...
void MyTitleBar::initControl()
{
    ...
    m_pButtonMax->setText("+");
    m_pButtonMin->setText("-");
